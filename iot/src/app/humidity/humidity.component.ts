...
export class HumidityComponent implements OnInit {
  ...
  url1Inside = "http://localhost:3000/d/YcEyXu3Wz/humidity?orgId=1&from=now-";
  url1OpenWeather='http://localhost:3000/d/p0ujg9qZk/humidity_openweather?orgId=1&from=now-';
